...
export default function ProfileScreen() {
  ...
  console.log("[ProfileScreen] Rendering, user:", user, "loading:", loading);
  ...
  const handleSignOut = async () => {
    ...
    try {
      await signOut();
      console.log("[ProfileScreen] Sign out complete, navigating to auth");
      router.replace("/auth");
    } catch (error) {
...
const profileStyles = StyleSheet.create({
  // Placeholder for any additional profile-specific styles
});
