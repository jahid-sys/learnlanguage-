...
export default function VocabularyScreen() {
  ...
  useEffect(() => {
    console.log('VocabularyScreen mounted');
    if (user) {
      loadVocabulary();
      loadDailyVocabulary();
    }
      ...
      <>
        ...
        <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
          <View style={styles.practiceHeader}>
            <TouchableOpacity onPress={() => setPracticeMode(false)} style={styles.closeButton}>
    ...
    <>
      ...
      <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
        <View style={styles.header}>
          <Text style={[styles.headerTitle, { color: colors.text }]}>Vārdnīca</Text>
          {vocabulary.length > 0 && (
            <TouchableOpacity style={styles.practiceHeaderButton} onPress={startPractice}>
              <LinearGradient colors={[colors.primary, colors.primaryDark]} style={styles.practiceHeaderButtonGradient}>
                <IconSymbol ios_icon_name="play.fill" android_material_icon_name="play-arrow" size={18} color="#FFFFFF" />
                <Text style={styles.practiceHeaderButtonText}>Praktizēt</Text>
              </LinearGradient>
            </TouchableOpacity>
          )}
        </View>
